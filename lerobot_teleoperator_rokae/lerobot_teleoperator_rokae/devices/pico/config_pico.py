...
class PicoConfig(TeleoperatorConfig):
    ...
    rot_scale_factor: float = 1             # 姿态增量缩放因子比例
    R_headset_world: list[float] = field(default_factory=lambda: [0.0, 0.0, 90.0]) # pico 头显到世界坐标系的旋转矩阵，ZYX Euler angles in degrees
