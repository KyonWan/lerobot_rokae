...
#      仓库内示例: config/record/single_spacemouse_example.yaml
#                config/record/dual_spacemouse_example.yaml
#                config/record/single_pico_example.yaml
#                config/record/dual_pico_example.yaml
#      ./scripts/record/rokae_record.sh --config_path=config/record/single_spacemouse_example.yaml
#      ./scripts/record/rokae_record.sh --config_path=config/record/single_spacemouse_example.yaml --dataset.root="./datasets/run_$(date +%Y%m%d_%H%M%S)"
