...
__all__ = ['Model_0_3', 'Model_0_4', 'Model_0_6', 'Model_1_5', 'Model_1_6', 'Model_1_7', 'SegmentFrame', 'TorqueType', 'xmateModel_1_5', 'xmateModel_1_6', 'xmateModel_1_7']
class Model_0_3:
    """
    用于在python中使用model类
    """
    ...
    def calcIk(self, posture: xCoreSDK_python.CartesianPosition, toolset: xCoreSDK_python.Toolset, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        ...
        """
    @typing.overload
    def calcIk_SearchElbow(self, posture: xCoreSDK_python.CartesianPosition, elb_accuracy: float, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        """
        根据位姿计算逆解。并自动遍历臂角
        
        Args:
            posture: 机器人末端位姿，相对于外部参考坐标系。参考的坐标系是通过setToolset()设置的
            elb_accuracy: 臂角精度
            ec: 错误码
        ...
        """
    @typing.overload
    def calcIk_SearchElbow(self, posture: xCoreSDK_python.CartesianPosition, toolset: xCoreSDK_python.Toolset, elb_accuracy: float, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        """
        根据位姿计算给定工具工件坐标系下逆解。并自动遍历臂角
...
class Model_0_4:
    ...
    def calcIk(self, posture: xCoreSDK_python.CartesianPosition, toolset: xCoreSDK_python.Toolset, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(4)]:
        ...
        """
    @typing.overload
    def calcIk_SearchElbow(self, posture: xCoreSDK_python.CartesianPosition, elb_accuracy: float, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(4)]:
        """
        根据位姿计算逆解。并自动遍历臂角
        ...
        """
    @typing.overload
    def calcIk_SearchElbow(self, posture: xCoreSDK_python.CartesianPosition, toolset: xCoreSDK_python.Toolset, elb_accuracy: float, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(4)]:
        """
        根据位姿计算给定工具工件坐标系下逆解。并自动遍历臂角
...
class Model_0_6:
    ...
    def calcIk(self, posture: xCoreSDK_python.CartesianPosition, toolset: xCoreSDK_python.Toolset, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)]:
        ...
        """
    @typing.overload
    def calcIk_SearchElbow(self, posture: xCoreSDK_python.CartesianPosition, elb_accuracy: float, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)]:
        """
        根据位姿计算逆解。并自动遍历臂角
        ...
        """
    @typing.overload
    def calcIk_SearchElbow(self, posture: xCoreSDK_python.CartesianPosition, toolset: xCoreSDK_python.Toolset, elb_accuracy: float, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)]:
        """
        根据位姿计算给定工具工件坐标系下逆解。并自动遍历臂角
...
class Model_1_5:
    ...
    def calcIk(self, posture: xCoreSDK_python.CartesianPosition, toolset: xCoreSDK_python.Toolset, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)]:
        ...
        """
    @typing.overload
    def calcIk_SearchElbow(self, posture: xCoreSDK_python.CartesianPosition, elb_accuracy: float, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)]:
        """
        根据位姿计算逆解。并自动遍历臂角
        ...
        """
    @typing.overload
    def calcIk_SearchElbow(self, posture: xCoreSDK_python.CartesianPosition, toolset: xCoreSDK_python.Toolset, elb_accuracy: float, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)]:
        """
        根据位姿计算给定工具工件坐标系下逆解。并自动遍历臂角
...
class Model_1_7:
    ...
    def calcIk(self, posture: xCoreSDK_python.CartesianPosition, toolset: xCoreSDK_python.Toolset, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)]:
        ...
        """
    @typing.overload
    def calcIk_SearchElbow(self, posture: xCoreSDK_python.CartesianPosition, elb_accuracy: float, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)]:
        """
        根据位姿计算逆解。并自动遍历臂角
        ...
        """
    @typing.overload
    def calcIk_SearchElbow(self, posture: xCoreSDK_python.CartesianPosition, toolset: xCoreSDK_python.Toolset, elb_accuracy: float, ec: dict) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)]:
        """
        根据位姿计算给定工具工件坐标系下逆解。并自动遍历臂角
...
class xmateModel_1_5:
    ...
    def getJointPos(self, cartPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(16)], elbow: float, jntInit: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], jntPos: list) -> int:
        ...
        Returns:
            计算逆解结果 -
                ...
                4)	-8: 机器人奇异；
        """
    def getJointPosSearchPsi(self, cartPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(16)], psi_accuracy: float, elbow: float, q_init: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], q: list) -> int:
        """
        目标比较从[-PI,PI]之间进行遍历，得到其中最近的逆解
            
        Args:
            cartPos: 法兰笛卡尔空间位姿
            psi_accuracy: 臂角求解精度，单位度(例如1、10、20)，精度越高，求解时间越长
            elbow: 臂角
            jntInit: 初始关节角度
            jntPos: 关节空间位置
    ...
    def getJointVel(self, cartVel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], jntPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)]) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)]:
        ...
        Returns:
            计算结果
        """
    def getTorque(self, jntPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], jntVel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], jntAcc: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], torque_type: TorqueType) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)]:
        """
        由模型计算关节力矩
    ...
    def getTorqueNoFriction(self, jntPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], jntVel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], jntAcc: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], trq_full: list, trq_inertia: list, trq_coriolis: list, trq_gravity: list) -> None:
        ...
        Args:
            ...
            trq_gravity: 重力矩
        """
    def getTorqueWithFriction(self, jntPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], jntVel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], jntAcc: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], trq_full: list, trq_inertia: list, trq_coriolis: list, trq_friction: list, trq_gravity: list) -> None:
        """
        由模型计算关节力矩，计算结果单位：Nm。如有负载，先通过setLoad()设置负载参数。
...
class xmateModel_1_6:
    ...
    def getJointPos(self, cartPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(16)], elbow: float, jntInit: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], jntPos: list) -> int:
        ...
        Returns:
            计算逆解结果 -
                ...
                4)	-8: 机器人奇异；
        """
    def getJointPosSearchPsi(self, cartPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(16)], psi_accuracy: float, elbow: float, q_init: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], q: list) -> int:
        """
        目标比较从[-PI,PI]之间进行遍历，得到其中最近的逆解
    ...
    def getJointVel(self, cartVel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], jntPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)]) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)]:
        ...
        Returns:
            计算结果
        """
    def getTorque(self, jntPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], jntVel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], jntAcc: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], torque_type: TorqueType) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)]:
        """
        由模型计算关节力矩
    ...
    def getTorqueNoFriction(self, jntPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], jntVel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], jntAcc: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], trq_full: list, trq_inertia: list, trq_coriolis: list, trq_gravity: list) -> None:
        ...
        Args:
            ...
            trq_gravity: 重力矩
        """
    def getTorqueWithFriction(self, jntPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], jntVel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], jntAcc: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], trq_full: list, trq_inertia: list, trq_coriolis: list, trq_friction: list, trq_gravity: list) -> None:
        """
        由模型计算关节力矩，计算结果单位：Nm。如有负载，先通过setLoad()设置负载参数。
...
class xmateModel_1_7:
    ...
    def getJointPos(self, cartPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(16)], elbow: float, jntInit: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], jntPos: list) -> int:
        ...
        Returns:
            计算逆解结果 -
                ...
                4)	-8: 机器人奇异；
        """
    def getJointPosSearchPsi(self, cartPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(16)], psi_accuracy: float, elbow: float, q_init: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], q: list) -> int:
        """
        目标比较从[-PI,PI]之间进行遍历，得到其中最近的逆解
    ...
    def getJointVel(self, cartVel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], jntPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)]) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)]:
        ...
        Returns:
            计算结果
        """
    def getTorque(self, jntPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], jntVel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], jntAcc: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], torque_type: TorqueType) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)]:
        """
        由模型计算关节力矩
    ...
    def getTorqueNoFriction(self, jntPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], jntVel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], jntAcc: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], trq_full: list, trq_inertia: list, trq_coriolis: list, trq_gravity: list) -> None:
        ...
        Args:
            ...
            trq_gravity: 重力矩
        """
    def getTorqueWithFriction(self, jntPos: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], jntVel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], jntAcc: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], trq_full: list, trq_inertia: list, trq_coriolis: list, trq_friction: list, trq_gravity: list) -> None:
        """
        由模型计算关节力矩，计算结果单位：Nm。如有负载，先通过setLoad()设置负载参数。
