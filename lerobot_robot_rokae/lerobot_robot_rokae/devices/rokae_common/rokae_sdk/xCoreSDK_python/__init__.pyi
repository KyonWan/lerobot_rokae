...
class BaseRobot:
    ...
    def setDefaultZone(self, zone: int, ec: dict) -> None:
        ...
        Args:
             zone (int): 转弯区半径大小。该接口不对参数进行范围限制。转弯区半径大小实际有效范围是[0, 200]。
             ec (dict): 错误码。若操作失败,错误码将被设置为相应的错误信息。
        """
